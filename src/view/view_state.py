...
class View:
    ...
    def _start_view(self):
        ...
        self.add_element(Button(self,"light_green_button",950,250,-1,-1, 25,(0,245,255),(187,255,255))) #turquoise
        ...
        self.add_element(Button(self,"start_button",100,600,250,100,-1,(100, 100, 100),(150,150,150),'square')) #orange
